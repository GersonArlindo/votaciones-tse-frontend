...
import { ViewRolPermisoComponent } from './view-rol-permiso/view-rol-permiso.component';
import { AddEditRolPermisoComponent } from './add-edit-rol-permiso/add-edit-rol-permiso.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'view/:id',
        component: ViewRolPermisoComponent,
      },
    ]
  },
]
...
@NgModule({
  declarations: [
    RolPermisoComponent,
    ViewRolPermisoComponent,
    AddEditRolPermisoComponent
    //LanguageComponent,
