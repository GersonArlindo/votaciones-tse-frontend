...
import { ViewDisqualificationComponent } from './view-disqualification/view-disqualification.component';
...
const routes: Routes = [
  {
    path: '',
    component: DisqualificationComponent,
    children: [
      ...
      {
        path: 'view',
        component: ViewDisqualificationComponent,
      }
    ]
  },
]
